...
class CasaRaizController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        return view('casa_raiz')->with('almacen_de_semillas', $almacen_de_semillas)->with('biblioteca', $biblioteca)->with('ludoteca', $ludoteca);
